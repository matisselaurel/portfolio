        ...
        <ul class='slides'>
          <li class='slide'>
            <section class='jumbotron'>
              <div class='bg' style='background-image:url(images/projects/12.jpg);'></div>
              <section>
                <div class='row'>
                  <div class='col-md-6'>
          ...
          <div class='col-md-6 col-md-offset-3'>
            <div class='text-center'>
              <div class='title-block'>
                <h3>Perfectly Built</h3>
              </div>
              <p>With a unique custom slider (less than 3kb) specially tailored for the Tera Template and modified Masonry columns that keep a certain aspect ratio, it's one of the most advanced, yet simplest templates out there.</p>
            </div>
          </div>
        </div>
      </section>
