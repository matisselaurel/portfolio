  ...
  <body>
    <div class='container-fluid'>
      ...
      <section class='jumbotron'>
        <div class='bg' style='background-image:url(images/projects/20.png);'></div>
        <section class='text-center'>
          <h1>Custom Architecture</h1>
        </section>
      </section>
      <section class='wide'>
        <div class='block'>
          <div class='row'>
            <div class='col-md-6'>
              ...
              <p>This project was a website redesign built with wordpress. I took lead on front and backend development <a href="http://www.customarchitecture.com">SEE SITE</a></p>
            </div>
            ...
            <div class='col-md-2'>
              <h4>Role</h4>
              <p>Web Developer, <br>Wordpress expert</p>
            </div>
          </div>
        </div>
      </section>
