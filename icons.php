...
<html>
  ...
  <body>
    <div class='container-fluid'>
      ...
      <section class='jumbotron small' style='background:#fff'>
        <section class='text-center'>
          <h1>Hundreds of sharp Retina icons.</h1>
          <h2>For any purpose.</h2>
        </section>
      </section>
      <section>
        <div class='block'>
          <div class='row'>
            <div class='fa-icon col-md-3 col-sm-4 col-xs-6'>
