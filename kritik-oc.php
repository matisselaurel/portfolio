  ...
  <body>
    <div class='container-fluid'>
      ...
      <section class='jumbotron'>
        <div class='bg' style='background-image:url(images/projects/23.png);'></div>
      ...
      <section class='wide'>
        <div class='block'>
          <div class='row'>
            <div class='col-md-6'>
              <h4>New Website</h4>
              <p>This is a photo sharing community site I designed and built from scracth using mvc patterns. <a href="http://www.kritik-oc.com">SEE SITE</a></p>
            </div>
            ...
            <div class='col-md-2'>
              <h4>Role</h4>
              <p>Web Developer, <br>PHP expert</p>
            </div>
          </div>
        </div>
      </section>
