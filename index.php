          ...
          <div class='row'>  
            <div class='col-md-8'>  
              ...
              <ul id='filters'>  
                ...
                <li>  
                  <button data-filter='.magento'>Magento</button>  
                </li>  
                <li>  
                  <button data-filter='.wordpress'>Wordpress</button>  
                </li>  
                <li>  
                  <button data-filter='.scratch'>Scratch</button>  
                </li>  
                <!-- <li>  
...
<li class='item magento'>  
              <a class='inner' href='alcatel' style='background:url(images/projects/alt.jpg);'>  
                <div class='caption'>
                  ...
                  <div class='titles'>  
                    <div class='title'>Alcatel</div>  
                    <div class='subtitle'>Magento 2 Developer</div>  
                  </div>  
                </div>  
              </a>  
            </li>  
              ...
              <a class='inner' href='robbins-brothers' style='background:url(images/projects/rbt.jpg);'>  
                <div class='caption'>  
                  <div class='field'>  
                    Magento 2 + eCommerce +  Wedding Rings  
                  </div>  
                  <div class='titles'>  
                    <div class='title'>Robbins Brothers</div>  
                    <div class='subtitle'>Magento 2 Developer</div>  
                  </div>  
                </div>  
              </a>  
...
<li class='item magento'>  
              <a class='inner' href='ld-products' style='background:url(images/projects/ldt.jpg);'>  
                <div class='caption'>  
                  <div class='field'>  
                    Magento + eCommerce + Ink and Toner  
                  </div>  
                  <div class='titles'>  
                    <div class='title'>LD Products</div>  
                    <div class='subtitle'>Lead Front End Developer</div>  
                  </div>  
                </div>  
              </a>  
            </li>  
	...
	<li class='item wordpress'>
            <a class='inner' href='custom-architecture' style='background:url(images/projects/20t.png);'>
              <div class='caption'>
                ...
                <div class='titles'>
                  <div class='title'>Brion Jeanette</div>
          ...
          <li class='item wordpress'>
            <a class='inner' href='hit-play-yoga' style='background:url(images/projects/21t.png);'>
              <div class='caption'>
                ...
                <div class='titles'>
                  <div class='title'>Hit Play Yoga</div>
                  <div class='subtitle'>Web Developer</div>
                </div>
              </div>
            </a>
          ...
          <li class='item magento'>
            <a class='inner' href='cindab' style='background:url(images/projects/22t.png);'>
              <div class='caption'>
                ...
                <div class='titles'>
                  <div class='title'>Cinda B</div>
                  <div class='subtitle'>Magento Developer</div>
                </div>
              </div>
            </a>
          </li>
          ...
          <li class='item scratch'>
            <a class='inner' href='hreference' style='background:url(images/projects/24t.png);'>
              <div class='caption'>
                ...
                <div class='titles'>
                  <div class='title'>Hreference</div>
                  <div class='subtitle'>Web Developer</div>
                </div>
              </div>
            </a>
           ...
           <li class='item magento'>
            <a class='inner' href='naturalbabyco' style='background:url(images/projects/25t.png);'>
              <div class='caption'>
                ...
                <div class='titles'>
                  <div class='title'>Natural Baby Company</div>
                  <div class='subtitle'>Magento Developer</div>
                </div>
              </div>
            </a>
          ...
          <li class='item magento'>
            <a class='inner' href='persimmontree' style='background:url(images/projects/29t.png);'>
              <div class='caption'>
                ...
                <div class='titles'>
                  <div class='title'>The Persimmon Tree</div>
                  <div class='subtitle'>Magento Developer</div>
                </div>
              </div>
            </a>
          ...
          <li class='item scratch'>
            <a class='inner' href='reveryapparel' style='background:url(images/projects/30t.png);'>
              <div class='caption'>
                ...
                <div class='titles'>
                  <div class='title'>Revery Apparel</div>
                  <div class='subtitle'>Web Developer</div>
                </div>
              </div>
            </a>
        ...
        <div class='row block'>
          <div class='col-md-6 col-md-offset-3'>
            <div class='text-center'>
              ...
              <p>Hey there! My name is Matisse and I make websites. I have a degree from the Art Institute of California - Orange County specializing in Interactive Media and Web Design. Altough I initially wanted to become a designer, I found my true calling in bringing websites to life by building interactive features. I am a Certified Magento Developer that has been working with php, mysql, javascript, jQuery, html, css, in the industry since 2010 and am very comfortable with picking up any cms framework. I love working with creative teams as a front end developer with full stack experience. Please take a look at my gallery to see the various projects I have worked on over the years.</p>
            </div>
          </div>
        </div>
      </section>
