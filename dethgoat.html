  ...
  <body>
    <div class='container-fluid'>
      ...
      <section class='jumbotron'>
        <div class='bg' style='background-image:url(images/projects/31.png);'></div>
      ...
      <section class='wide'>
        <div class='block'>
          <div class='row'>
            <div class='col-md-6'>
              <h4>New Website</h4>
              <p>This is a band blog site I designed and built from scracth using mvc patterns. <a href="http://www.dethgoat.com">SEE SITE</a></p>
            </div>
