  ...
  <body>
    <div class='container-fluid'>
      ...
      <section class='jumbotron'>
        <div class='bg' style='background-image:url(images/projects/25.png);'></div>
        <section class='text-center'>
          <h1>Natural Baby Company</h1>
        </section>
      </section>
      <section class='wide'>
        <div class='block'>
          <div class='row'>
            <div class='col-md-6'>
              <h4>Maintenance</h4>
              <p>This is retail baby supplies store I did maintenance on. <a href="http://www.thenaturalbabyco.com">SEE SITE</a></p>
            </div>
