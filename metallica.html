  ...
  <body>
    <div class='container-fluid'>
      ...
      <section class='jumbotron'>
        <div class='bg' style='background-image:url(images/projects/34.png);'></div>
        ...
        <div class='block'>
          <div class='row'>
            <div class='col-md-6'>
              ...
              <p>This project was a hybrid of Magento and Drupal.</p>
            </div>
            ...
            <div class='col-md-2'>
              <h4>Role</h4>
              <p>Front End Developer, <br>Magento/Drupal expert</p>
            </div>
          </div>
        </div>
      </section>
