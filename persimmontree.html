  ...
  <body>
    <div class='container-fluid'>
      ...
      <section class='jumbotron'>
        <div class='bg' style='background-image:url(images/projects/29.png);'></div>
        <section class='text-center'>
          <h1>The Persimmon Tree</h1>
        </section>
      </section>
      <section class='wide'>
        <div class='block'>
          <div class='row'>
            <div class='col-md-6'>
              <h4>New Website</h4>
              <p>This is a Magento website I did maintenance work on. <a href="http://www.thepersimmontreetea.com">SEE SITE</a></p>
            </div>
            <div class='col-md-2 col-md-offset-2'>
              <h4>Client</h4>
              <p>The Persimmon Tree</p>
              <h4>Created</h4>
              <p>2011-2012</p>
            </div>
            <div class='col-md-2'>
              <h4>Role</h4>
              <p>Web Developer, <br>Magento expert</p>
            </div>
          </div>
        </div>
      </section>
