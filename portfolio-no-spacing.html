    ...
    <div class='container-fluid'>
      ...
      <section class='jumbotron small'>
        <section>
          <div class='row'>
            <div class='col-md-7'>
              <h1>Portfolio - no spacing</h1>
            </div>
            <div class='col-md-5'>
              <div id='filter-trigger'>Filter</div>
              <ul class='pull-right' id='filters'>
                <li>
      ...
      <section class='work'>
        <ul class='no-spacing' id='grid'>
          <li class='item photography illustration'>
            <a class='inner' href='single.html' style='background:url(images/projects/17.jpg);'>
              <div class='caption'>
                <div class='field'>
                  Identity + Design
                </div>
          ...
          <li class='item photography'>
            <a class='inner' href='single.html' style='background:url(images/projects/05.png);'>
              <div class='caption'>
                <div class='field'>
                  Design
                </div>
          ...
          <li class='item identity'>
            <a class='inner' href='single.html' style='background:url(images/projects/12.jpg);'>
              <div class='caption'>
                <div class='field'>
                  Typography + Branding
                </div>
          ...
          <li class='item design'>
            <a class='inner' href='single.html' style='background:url(images/projects/15.jpg);'>
              <div class='caption'>
                <div class='field'>
                  Design + Print
                </div>
          ...
          <li class='item high design identity'>
            <a class='inner' href='single.html' style='background:url(images/projects/02.jpg);'>
              <div class='caption'>
                <div class='field'>
                  Design + Identity
                </div>
          ...
          <li class='item design identity'>
            <a class='inner' href='single.html' style='background:url(images/projects/04.jpg);'>
              <div class='caption'>
                <div class='field'>
                  Design + Identity
                </div>
          ...
          <li class='item design illustration'>
            <a class='inner' href='single.html' style='background:url(images/projects/17.png);'>
              <div class='caption'>
                <div class='field'>
                  Design + Interaction
                </div>
          ...
          <li class='item design'>
            <a class='inner' href='single.html' style='background:url(images/projects/16.jpg);'>
              <div class='caption'>
                <div class='field'>
                  Design + Print
                </div>
                <div class='titles'>
                  <div class='title'>Grovik</div>
                  <div class='subtitle'>Businesscard</div>
                </div>
              </div>
            </a>
          </li>
          <li class='item identity'>
            <a class='inner' href='single.html' style='background:url(images/projects/11.jpg);'>
              <div class='caption'>
                <div class='field'>
                  Design + Identity
                </div>
          ...
          <li class='item wide'>
            <a class='inner' href='single.html' style='background:url(images/projects/07.jpg);'>
              <div class='caption'>
                <div class='field'>
                  Design + Interaction
                </div>
