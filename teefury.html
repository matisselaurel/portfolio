  ...
  <body>
    <div class='container-fluid'>
      ...
      <section class='jumbotron'>
        <div class='bg' style='background-image:url(images/projects/18.png);'></div>
      ...
      <section class='wide'>
        <div class='block'>
          <div class='row'>
            <div class='col-md-6'>
              <h4>Replatforming from Symfony to Magento</h4>
              <p>This project was a replatform from the Symfony Framework to Magento eCommerce platform. This project lasted about 8 months. My main role was the Lead frontend Developer. I installed their forum and blog extensions and ran their data imports. <a href="http://www.teefury.com">SEE SITE</a></p>
            </div>
            ...
            <div class='col-md-2'>
              <h4>Role</h4>
              <p>Web Developer, <br>Frontend expert</p>
            </div>
          </div>
        </div>
      </section>
      <!-- <section class='block'>
        ...
        <ul class='col-3' id='grid'>
          ...
          <li class='item'>
            <a class='inner' href='single.html' style='background:url(images/projects/14.jpg);'>
              <div class='caption'>
                <div class='field'>
                  Design + Identity
                </div>
      ...
      <footer>
        <section class='text-center'>
          <div class='social'>
            ...
            <a class='icon fa fa-print' href='/MatisseLaurelresume2015.pdf'></a>
          ...
          <div class='copy'>
            &copy; 2015 Matisse Laurel. All Rights Reserved.
          </div>
        </section>
      </footer>
    </div>
